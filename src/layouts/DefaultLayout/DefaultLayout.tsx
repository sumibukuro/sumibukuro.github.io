      ...
      {!game ? (
        ...
        <>
          ...
          <div className={styles.DefaultLayout__BottomButtons}>
            ...
            <div className={classnames(styles.DefaultLayout__IconButton, styles['DefaultLayout__IconButton--Usage'])} style={{ animation: `${styles['fade-in-bottom-btn']} 0.2s ease 0.2s forwards` }} onClick={() => setIsVisibleUsage(!isVisibleUsage)}>
              <GoQuestion></GoQuestion>
            </div>
            <div className={classnames(styles.DefaultLayout__IconButton, styles['DefaultLayout__IconButton--Shop'])} style={{ animation: `${styles['fade-in-bottom-btn']} 0.2s ease 0.3s forwards` }} onClick={() => setIsVisibleShop(!isVisibleShop)}>
              <GoRuby></GoRuby>
            </div>
